        ...
        <Collapse isOpen={isSettingOpen}>
          <Nav class="sb-sidenav-menu-nested">
            <SidebarItem
              ...
              class={segment === 'settings' && activeLink === 'Notification Settings' ? 'active' : ''}
            ...
            <SidebarItem
              ...
              class={segment === 'settings' && activeLink === 'Privacy Policy' ? 'active' : ''}
              ...
              class={segment === 'settings' && activeLink === 'Terms and Conditions' ? 'active' : ''}
